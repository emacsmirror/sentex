...
I'm working on programmatically converting the rulesets for all languages that have one. Work so far is in =segment-convert.el=. I'm correcting errors as I encounter them.
